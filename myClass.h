...
// Mon Nov  9 23:08:37 2020 by ROOT version 5.34/34
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/NEW_WORK_Brem/pn_Brem_627MeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/NEW_WORK_Brem/pn_Brem_627MeV.root");
      }
      ...
      chain->Add("/lustre/nyx/hades/user/nrathod/PLUTO/TEST/NEW_WORK_Brem/pn_Brem_627MeV.root/data");
      tree = chain;
#endif // SINGLE_TREE
